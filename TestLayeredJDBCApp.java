			...
			while (!exit) {
				...
				try {
					...
					case 4 :
						...
						System.out.println("changed password " + userDao.UpdatePassword(sc.next(), sc.next(), sc.next()));
						break;
					case 5 :
						System.out.println("enter id ");
						System.out.println("deleted entry "+userDao.DeleteUserDetails(sc.nextInt()));
						break;
					case 0:
						exit = true;
